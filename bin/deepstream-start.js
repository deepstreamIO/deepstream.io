...
module.exports = function (program) {
  program
    ...
    .option('--cluster-port <port>', 'port for listening to TCP connections from deepstream cluster', parseInteger.bind(null, '--cluster-port'))
    .option('-j, --join <hosts>', 'a comma-seperated list of cluster seed-nodes to connect to e.g. "localhost:1234,localhost:1235"')
