...
const listener_test_utils_1 = require("./listener-test-utils");
let tu;
describe('listener-registry-local-load-balancing', () => {
    beforeEach(() => {
        tu = new listener_test_utils_1.default();
    });
    afterEach(() => {
        tu.complete();
    });
...
describe('listener-registry-local-load-balancing does not send publishing updates for events', () => {
    beforeEach(() => {
        tu = new listener_test_utils_1.default(C.TOPIC.EVENT);
    });
    afterEach(() => {
        tu.complete();
    });
...
//# sourceMappingURL=listener-registry-load-balancingSpec.js.map