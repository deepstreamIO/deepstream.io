...
describe('file based authentication', () => {
    describe('does authentication for cleartext passwords', () => {
        ...
        beforeEach(done => {
            authenticationHandler = new file_based_authentication_handler_1.default(settings);
    ...
    describe('errors for invalid settings', () => {
        ...
        it('accepts valid settings', () => {
            expect(() => {
                ...
                new file_based_authentication_handler_1.default(getSettings());
            }).not.toThrow();
        });
        xit('errors for invalid path', () => {
            ...
            expect(() => {
                // tslint:disable-next-line:no-unused-expression
                new file_based_authentication_handler_1.default(settings);
            }).toThrow();
        });
    ...
    describe('errors for invalid configs', () => {
        it('loads a non existant config', done => {
            const authenticationHandler = new file_based_authentication_handler_1.default({
...
//# sourceMappingURL=file-based-authentication-handlerSpec.js.map