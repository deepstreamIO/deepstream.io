    ...
    describe('fromJIF', () => {
        ...
        describe('events', () => {
            ...
            it('should reject malformed topics', () => {
                ...
                const results = topics.map(topic => jifHandler.fromJIF({ topic, action: 'emit', eventName: 'time/berlin' }));
            ...
            it('should reject malformed actions', () => {
                ...
                const results = actions.map(action => jifHandler.fromJIF({ topic: 'event', action, eventName: 'time/berlin' }));
                results.forEach((result, i) => expect(result.success).to.equal(false, i));
            });
            ...
            it('should reject malformed names', () => {
                ...
                const results = names.map(eventName => jifHandler.fromJIF({ topic: 'event', action: 'emit', eventName }));
                results.forEach((result, i) => expect(result.success).to.equal(false, i));
            });
        });
        describe('rpcs', () => {
...
//# sourceMappingURL=jif-handlerSpec.js.map