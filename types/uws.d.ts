...
function App(options?: AppOptions): TemplatedApp;

/** Constructs an SSL app */
function SSLApp(options: AppOptions): TemplatedApp;

/** Closes a uSockets listen socket. */
function us_listen_socket_close(listenSocket: us_listen_socket): void;
