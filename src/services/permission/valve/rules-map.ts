...
import { TOPIC, RECORD_ACTIONS, EVENT_ACTIONS, RPC_ACTIONS, PRESENCE_ACTIONS, Message } from '../../../constants'
...
const RULES_MAP: Dictionary<{ section: string, actions: Dictionary<RuleType> }> = {
  [TOPIC.RECORD]: {
    section: 'record',
    actions: {
      [RECORD_ACTIONS.SUBSCRIBEANDHEAD]: RULE_TYPES.READ,
      [RECORD_ACTIONS.SUBSCRIBEANDHEAD_BULK]: RULE_TYPES.READ,
      [RECORD_ACTIONS.SUBSCRIBEANDREAD]: RULE_TYPES.READ,
      [RECORD_ACTIONS.SUBSCRIBEANDREAD_BULK]: RULE_TYPES.READ,
      [RECORD_ACTIONS.READ]: RULE_TYPES.READ,
      [RECORD_ACTIONS.HEAD]: RULE_TYPES.READ,
      ...
      [RECORD_ACTIONS.NOTIFY]: RULE_TYPES.NOTIFY,
  ...
  [TOPIC.EVENT]: {
    ...
    actions: {
      ...
      [EVENT_ACTIONS.SUBSCRIBE_BULK]: RULE_TYPES.SUBSCRIBE,
  ...
  [TOPIC.PRESENCE]: {
    ...
    actions: {
      ...
      [PRESENCE_ACTIONS.SUBSCRIBE_BULK]: RULE_TYPES.ALLOW,
      [PRESENCE_ACTIONS.SUBSCRIBE_ALL]: RULE_TYPES.ALLOW,
